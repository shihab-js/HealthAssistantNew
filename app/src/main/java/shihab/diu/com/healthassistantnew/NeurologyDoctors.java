...
public class NeurologyDoctors extends AppCompatActivity {

    ListView listView;

    int[] IMAGES = {R.drawable.neurolory, R.drawable.neurolory, R.drawable.neurolory, R.drawable.neurolory, R.drawable.neurolory, R.drawable.neurolory, R.drawable.neurolory, R.drawable.neurolory};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_neurology_doctors);


        listView=(ListView)findViewById(R.id.list_doctor_neurology);
